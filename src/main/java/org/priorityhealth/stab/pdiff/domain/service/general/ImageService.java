...
public class ImageService {
    ...
    public static void saveImageFromBufferedImage(BufferedImage img, String path) {
        ...
        try {
            ...
            LogService.Info("Saved image to: " + file.getAbsolutePath());
    ...
    public static BufferedImage loadBufferedImageFromFile(String path) {
        ...
        try {
            ...
            LogService.Info("Successfully loaded: " + file.getAbsolutePath());
        } catch (IOException ex) {
            LogService.Info("IOException: " + ex.getMessage());
            ex.printStackTrace();
        }
    ...
    public static Rectangle calculateMaxDimensions(BufferedImage... images) {
        ...
        LogService.Info("Max Dimensions: " + newDimensions.toString());
